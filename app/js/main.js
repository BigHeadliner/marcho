$(function () {   
  ...
  $('.filter-price__input').ionRangeSlider({ 
     ...
     onStart: function (data) { 
      ...
      $('.filter-price__too').text(data.to);  
     },
  ...
  initializeClock('promo__clockpromo__', deadline);
